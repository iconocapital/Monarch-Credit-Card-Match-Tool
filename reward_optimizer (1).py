...
CARD_DB: dict[str, CardProfile] = {
    ...
    "Amex Platinum": CardProfile(
        ...
        base_rate=0.01,
        cpp_valuation=2.0,  # MR points ~2.0 cpp via transfer partners
        categories={
    ...
    "Chase Sapphire Reserve": CardProfile(
        ...
        annual_fee=795,  # effective $495 after $300 travel credit
    ...
    "Capital One Venture X": CardProfile(
        ...
        annual_fee=395,  # effective $95 after $300 travel credit
        currency="Capital One Miles",
        base_rate=0.02,
        cpp_valuation=1.5,  # C1 miles ~1.5 cpp via transfer partners
        categories={
    ...
    "Amex Gold": CardProfile(
        name="Amex Gold",
        annual_fee=325,  # effective ~$0 after dining/Uber credits
        currency="Membership Rewards",
        base_rate=0.01,
        cpp_valuation=2.0,
        categories={
    ...
    "Citi Strata Premier": CardProfile(
        ...
        base_rate=0.01,
        cpp_valuation=1.8,  # TY points ~1.8 cpp via transfer partners
        categories={
            "hotels": 0.03,
            "airlines": 0.03,
            "dining": 0.03,
    ...
    "Capital One VentureOne": CardProfile(
        ...
        cpp_valuation=1.0,  # simple redemption
    ),
    "Bilt Mastercard": CardProfile(
        ...
        categories={
            "housing": 0.01,  # unique: earn on rent with no fee
            "dining": 0.02,
        },
    ),
    ...
    "Chase Freedom Unlimited": CardProfile(
        ...
        currency="Ultimate Rewards",
        base_rate=0.015,
        cpp_valuation=1.0,  # 1.0 as cash; 2.0 if paired with CSR/CSP
        categories={
            "dining": 0.03,
            "pharmacy": 0.03,
    ...
    "Chase Freedom Flex": CardProfile(
        ...
        currency="Ultimate Rewards",
        base_rate=0.01,
        cpp_valuation=1.0,  # 2.0 if paired with CSR/CSP
        categories={
            "dining": 0.03,
            "pharmacy": 0.03,
    ...
    "Citi Custom Cash": CardProfile(
        ...
        currency="ThankYou Points",
        base_rate=0.01,
        cpp_valuation=1.0,  # 1.8 if paired with Strata Premier
        categories={
...
SIGNUP_BONUSES: dict[str, str] = {
    # Premium Travel
    "Amex Platinum":             "150,000 MR pts ($8k/6mo) ≈ $3,000 at 2.0 cpp",
    "Chase Sapphire Reserve":    "60,000 UR pts ($4k/3mo) ≈ $1,200 at 2.0 cpp",
    "Capital One Venture X":     "75,000 miles ($4k/3mo) ≈ $1,125 at 1.5 cpp",
    # Mid-Tier Travel
    "Chase Sapphire Preferred":  "60,000 UR pts ($4k/3mo) ≈ $1,200 at 2.0 cpp",
    "Capital One Venture":       "75,000 miles ($4k/3mo) ≈ $1,125 at 1.5 cpp",
    "Amex Gold":                 "60,000 MR pts ($6k/6mo) ≈ $1,200 at 2.0 cpp",
    "Citi Strata Premier":       "75,000 TY pts ($4k/3mo) ≈ $1,350 at 1.8 cpp",
    # No-Fee Travel
    "Capital One VentureOne":    "20,000 miles ($500/3mo) ≈ $200",
    "Bilt Mastercard":           "None (points on rent from day 1)",
    # Flat Rate Cash Back
    "Chase Freedom Unlimited":   "$200 back ($500/3mo)",
    ...
    "Citi Custom Cash":          "$200 back ($1.5k/6mo)",
    # Store / Co-Brand
    "Amazon Prime Visa":         "$200 Amazon gift card (instant approval)",
    ...
    def _get_issuer(self, card_name: str) -> str:
        ...
        issuer_map = {
            "Chase": ["Chase Sapphire Reserve", "Chase Sapphire Preferred",
                       "Chase Freedom Unlimited", "Chase Freedom Flex", "Amazon Prime Visa"],
            "Amex": ["Amex Platinum", "Amex Gold", "Amex Blue Cash Preferred", "Amex Blue Cash Everyday"],

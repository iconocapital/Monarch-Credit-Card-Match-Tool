...
with st.sidebar:
    ...
    existing_cards = []
    for card_name in sorted(CARD_DB.keys()):
        if st.checkbox(card_name, key=f"card_{card_name}"):
...
if uploaded_file:
    ...
    # Demo dataset
    df = pd.DataFrame([
        {"Category": "Rent",              "Amount": 3200, "Date": "2026-02-01"},
        {"Category": "Renters Insurance", "Amount": 120,  "Date": "2026-02-01"},
        {"Category": "HOA Dues",          "Amount": 880,  "Date": "2026-02-01"},
        {"Category": "Groceries",         "Amount": 320,  "Date": "2026-02-05"},
        {"Category": "Groceries",         "Amount": 285.50,"Date": "2026-02-12"},
        {"Category": "Groceries",         "Amount": 310,  "Date": "2026-02-19"},
        {"Category": "Groceries",         "Amount": 235,  "Date": "2026-02-26"},
        {"Category": "Restaurants",       "Amount": 185,  "Date": "2026-02-07 20:00"},
        {"Category": "Restaurants",       "Amount": 95,   "Date": "2026-02-08 19:30"},
        {"Category": "Coffee Shops",      "Amount": 65,   "Date": "2026-02-10"},
        {"Category": "Fast Food",         "Amount": 45,   "Date": "2026-02-15"},
        {"Category": "Restaurants",       "Amount": 160,  "Date": "2026-02-18 12:00"},
        {"Category": "Bars & Alcohol",    "Amount": 150,  "Date": "2026-02-14 22:00"},
        {"Category": "Gas",               "Amount": 245,  "Date": "2026-02-06"},
        {"Category": "Gas",               "Amount": 210,  "Date": "2026-02-20"},
        {"Category": "Auto Insurance",    "Amount": 285,  "Date": "2026-02-01"},
        {"Category": "Auto Maintenance",  "Amount": 180.30,"Date": "2026-02-22"},
        {"Category": "Public Transit",    "Amount": 200,  "Date": "2026-02-15"},
        {"Category": "Shopping",          "Amount": 520,  "Date": "2026-02-03"},
        {"Category": "Electronics",       "Amount": 380,  "Date": "2026-02-10"},
        {"Category": "Clothing",          "Amount": 350,  "Date": "2026-02-14"},
        {"Category": "Home Improvement",  "Amount": 200,  "Date": "2026-02-21"},
        {"Category": "Gas & Electric",    "Amount": 420,  "Date": "2026-02-15"},
        {"Category": "Water",             "Amount": 85,   "Date": "2026-02-15"},
        {"Category": "Internet & Cable",  "Amount": 110,  "Date": "2026-02-01"},
        {"Category": "Phone",             "Amount": 145,  "Date": "2026-02-01"},
        {"Category": "Streaming Services","Amount": 80,   "Date": "2026-02-01"},
        {"Category": "Education",         "Amount": 1060, "Date": "2026-02-01"},
        {"Category": "Insurance",         "Amount": 340,  "Date": "2026-02-15"},
        {"Category": "Health Insurance",  "Amount": 520,  "Date": "2026-02-01"},
        {"Category": "Charity",           "Amount": 250,  "Date": "2026-02-20"},
        {"Category": "Financial Fees",    "Amount": 125,  "Date": "2026-02-15"},
        {"Category": "Gifts",             "Amount": 180,  "Date": "2026-02-14"},
        {"Category": "Pets",              "Amount": 275,  "Date": "2026-02-22"},
        {"Category": "Medical",           "Amount": 239.02,"Date": "2026-02-18"},
    ])
...
with col1:
    st.metric("Monthly Spend", f"${summary['total_spend']:,.0f}")
with col2:
...
# Opportunity flags
if summary["ach_leakage_potential"] > 0 or summary["insurance_opportunity"] > 0:
    st.markdown("---")
    opp1, opp2 = st.columns(2)
    with opp1:
        if summary["ach_leakage_potential"] > 0:
            annual_ach = summary["ach_leakage_potential"] * 12
            st.warning(f"⚡ **ACH Leakage:** ${annual_ach:,.0f}/yr in rewards lost by paying housing/utilities via bank transfer")
    with opp2:
